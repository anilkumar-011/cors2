...
def after_request(response):
    ...
    response.headers["access-control-allow-headers"] = "Content-Type, Authorization, Anil,xa4vrhyp3q-a,xa4vrhyp3q-b,xa4vrhyp3q-c,xa4vrhyp3q-d,xa4vrhyp3q-f,xa4vrhyp3q-z"
    return response
